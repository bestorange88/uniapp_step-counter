var Turntable = (function () {
    ...
    Turntable.prototype.init = function () {
        ...
        var scratchMove = function(e) {
            e.preventDefault();
            if (!_this.options.isReward) {
                _this.options.reward();
                _this.options.isReward = true;
            }
            _this.Turntable(e);
    ...
    Turntable.prototype.setCursor = function() {
        var string = '';
    ...
    Turntable.prototype.update = function() {
        this.zone = this.canvas.getBoundingClientRect();
    };

    Turntable.prototype.redraw = function () {
    ...
    Turntable.prototype.setBackground = function() {
        var _this = this;
    ...
    Turntable.prototype.clearPoint = function (x1, y1) {
    ...
    Turntable.prototype.getPosition = function(e) {
        var posX, posY;
        switch (e.type) {
            case 'touchmove':
    ...
    Turntable.prototype.turntable = function(e) {
    ...
    Turntable.prototype.getPercent = function() {
        var percent;
    ...
    Turntable.prototype.clear = function() {
    ...
    Turntable.prototype.callback = function(callback) {
